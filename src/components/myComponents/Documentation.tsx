...
export default function Documentation() {
  ...
  return (
    <div className="min-h-screen text-white p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-gray-900 rounded-2xl shadow-lg p-6 space-y-4">
          <h2 className="text-2xl font-semibold text-gold">🚀 Innehåll</h2>
  ...
  code: \`<button class="cool-button">Klicka här</button>\`,
        ...
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/")}
            className="px-6 py-3 bg-gray-900 rounded-xl transition"
          >
